...
_track = [None, r34.mn(inv0.pins['O'])[0,1]]
dsn.route_via_track(grid=r34, mn=mn_list, track=_track)
...
#internal
mn_list = [r23_cmos.mn(nand0.pins['OUT'])[0], r23_cmos.mn(inv1.pins['I'])[0]]
_track = [None, r23_cmos.mn(nand0.pins['OUT'])[0,1]]
dsn.route_via_track(grid=r23_cmos, mn=mn_list, track=_track)
