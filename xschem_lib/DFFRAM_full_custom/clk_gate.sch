...
N 540 -30 560 -30 {
lab=CK_O}
C {xschem_lib/DFFRAM_full_custom/inv.sym} -170 40 0 0 {name=X_inv1 NF=NF}
C {xschem_lib/DFFRAM_full_custom/latch.sym} 40 70 0 0 {name=X_latch1 NF=NF}
...
C {xschem_lib/DFFRAM_full_custom/nand.sym} 260 0 0 0 {name=X_nand1 NF=NF}
C {lab_wire.sym} 290 -80 1 0 {name=l3 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 290 20 2 0 {name=l4 sig_type=std_logic lab=VSS}
C {xschem_lib/DFFRAM_full_custom/inv.sym} 400 10 0 0 {name=X_inv2 NF=NF*3}
