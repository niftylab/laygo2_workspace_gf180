...
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 -260 0 0 {name=X_nand1 NF=1}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 -70 0 0 {name=X_nand2 NF=1}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 120 0 0 {name=X_nand3 NF=1}
C {xschem_lib/DFFRAM_full_custom/nand_3in.sym} 90 310 0 0 {name=X_nand4 NF=1}
C {lab_wire.sym} -370 -500 0 0 {name=l11 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -250 -500 2 0 {name=l12 sig_type=std_logic lab=VDD}
